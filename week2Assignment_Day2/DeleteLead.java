...
public class DeleteLead {
	...
	//Navigate to Phone and enter the details
	driver.findElement(By.xpath("//span[text()='Phone']")).click();
	driver.findElement(By.xpath("//input[@name='phoneNumber']")).sendKeys("7708768258");
	driver.findElement(By.xpath("//button[text()='Find Leads']")).click();
	
	//Click on the First resulting lead
	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
	WebElement Row1=driver.findElement(By.xpath("//div[@class='x-grid3-cell-inner x-grid3-col-partyId']/a"));
	String first=Row1.getText();
	System.out.println("First Lead Value :\n"+first);
	...
	//Searching for the deleted Lead
	driver.findElement(By.xpath("(//input[contains(@name,'first')])[3]")).sendKeys(first);
